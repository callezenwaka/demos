      ...
      <div class='login--form'>
        <form @click.prevent="handleLogin">
          <div class="login--item" style="text-align: left;">
            ...
            <select class="login--input" v-model="user.id" name="user" id="user" required>
          ...
          <div class="login--item">
            <button type="submit" class="login--button" :class="{ active: isValid }">Login <span
                class="login--arrow">&#10142;</span></button>
          </div>
        </form>
      </div>
    </div>
